...
This is an internal helper function to check if two or more vectors have
same elements (with their order considered as an option).
...
- ignore_order:
  ...
  logical scalar to disregard the ordering of elements in input vectors.
  Default is TRUE.
