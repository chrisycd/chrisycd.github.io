# Parallelization options in scDesignPop

## Introduction

scDesignPop provides four different parallelization options:
“pbmcapply”, “future.apply”, “parallel”, “biocparallel”. In this
tutorial, we take
[`fitMarginalPop()`](https://github.com/chrisycd/scDesignPop/reference/fitMarginalPop.md)
function as example, to show how parameter should be specifed for each
of the parallel options.
